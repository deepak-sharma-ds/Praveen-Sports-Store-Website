{!! view_render_event('product360.admin.catalog.product.edit.form.360_view.before', ['product' => $product]) !!}
...
<div class="box-shadow relative rounded bg-white p-4 dark:bg-gray-900">
    ...
    <!-- Vue Component for 360 Image Management -->
    @php
...
{!! view_render_event('product360.admin.catalog.product.edit.form.360_view.after', ['product' => $product]) !!}
        ...
        app.component('v-product360-images', {
            ...
            methods: {
                ...
                async uploadFiles(files) {
                    ...
                    try {
                        ...
                        tempImages.forEach(tempImg => {
                            const index = this.images.findIndex(img => img.id === tempImg.id);
                            if (index !== -1) {
                ...
                async handleReorder() {
                    ...
                    const order = this.images.map((img, index) => ({
                        id: img.id,
                        position: index + 1
                    }));
