    ...
    <div class="container mt-8 max-1239:px-5 max-md:mt-6 max-md:px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div class="flex-1">
                ...
                <div class="mt-14 rounded max-sm:mt-8">
                    <x-shop::form :action="route('shop.home.contact_us.send_mail')">
                        ...
                        <div class="mt-6">
                            <button
                                class="w-full max-w-[350px] py-4 rounded-xl mx-auto block text-base border border-[#902129] text-[#902129] py-3 px-10 text-center"
                                type="submit">
            ...
            <div class="flex-1">
                <div class="mt-14 rounded max-sm:mt-8">
                    ...
                    <div class="py-8 rounded-xl">
                        <p class="flex items-start gap-3 text-lg">
                            <svg class="flex-[0_0_26px]" width="26" height="26" fill="none" stroke="#000"
                        ...
                        <p class="flex items-center gap-3 mt-4">
                            <svg class="flex-[0_0_26px]" width="25" height="25" fill="#000">
                                <path
                ...
                <iframe
                    src="https://www.google.com/maps?q=ANA+SPORTS,+Meerut&ll=28.9804747,77.7934176&z=17&output=embed"
