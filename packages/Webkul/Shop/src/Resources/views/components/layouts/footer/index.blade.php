...
@endif
<section>
    <div class="text-center mb-10 px-4 md:px-10 pt-8">
        <h2 class="font-secondary text-xl md:text-2xl uppercase">Explore the Exclusive Collection of ANA Sports</h2>
...
<footer class="bg-black text-white">
    <div
        ...
        <div>
            ...
            <div>
                <p class="mt-3 text-white inline-flex items-center gap-2 max-w-[400px]"><span
                        class="icon-telephone self-start w-6"><svg class="w-5 h-5" width="26" height="24" fill="none"
                ...
                <p class="mt-3"><a class="text-white inline-flex items-center gap-2"
                        href="mailto:supports@ana-sports.com"><span class="icon-telephone w-6"><svg class="w-5 h-5" width="26"
                ...
                <p class="mt-3"><a class="text-white inline-flex items-center gap-2" href="tel:9311048371"><span
                            class="icon-telephone w-6"><svg class="w-5 h-5" width="25" height="25" viewBox="0 0 25 25"
                ...
                <p class="mt-3"><a class="text-white inline-flex items-center gap-2"
                        href="https://wa.me/917042426901"><span class="icon-telephone w-6"><svg class="w-5 h-5" width="25"
                                height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                                <path
        ...
        <div class="hidden flex-wrap items-start gap-5 lg:flex flex-1 max-w-xl">
            @if ($customization?->options)
                @foreach ($customization->options as $footerLinkSection)
                    <ul class="grid gap-5 text-sm flex-1">
                        @php
