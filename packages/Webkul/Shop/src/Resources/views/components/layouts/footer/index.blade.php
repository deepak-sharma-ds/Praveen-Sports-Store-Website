...
<section class="grid grid-cols-2 gap-2.5 text-lg">
    <div class="relative text-center z-0">
        <img src="http://127.0.0.1:8000/storage/theme/13/banner-left.png" alt="" class="w-full h-full object-cover" />
        <div class="absolute top-0 left-0 bottom-0 right-0 z-[1] bg-gradient-to-t from-black to-black opacity-10"></div>
        <div class="absolute top-0 left-1/2 transform -translate-x-1/2 w-full p-10 text-white font-medium max-w-[540px] z-[2]">
            ...
            <div class="text-center mt-5">
                <a href="#" class="uppercase inline-flex items-center gap-2.5 text-[#902129] hover:text-white border border-[#902129] px-4 py-2.5 bg-white rounded hover:bg-[#902129] transition-all duration-300">
                    Shop Now
                </a>
            </div>
        </div>
    ...
    <div class="relative text-center z-0">
        <img src="http://127.0.0.1:8000/storage/theme/13/banner-right.png" alt="" class="w-full h-full object-cover" />
        <div class="absolute top-0 left-0 bottom-0 right-0 z-[1] bg-gradient-to-t from-black to-black opacity-10"></div>
        <div class="absolute top-0 left-1/2 transform -translate-x-1/2 w-full p-10 text-white font-medium max-w-[540px]">
            <h2 class="font-secondary text-4xl font-normal uppercase">Power. Precision. Price Drop.</h2>
            <p class="mt-4">Enjoy 20% off on select professional cricket bats. Limited-time offer — gear up before it's gone!</p>
            <div class="text-center mt-5">
                <a href="#" class="uppercase inline-flex items-center gap-2.5 text-[#902129] hover:text-white border border-[#902129] px-4 py-2.5 bg-white rounded hover:bg-[#902129] transition-all duration-300">
                    Shop Now
                </a>
    ...
    <div class="text-center mb-10 px-10 pt-8">
        ...
        <div class="text-center mt-5">
            <a href="#" class="uppercase inline-flex items-center gap-2.5 text-[15px]"> 
                View All 
                <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.93357 7.50609L4.95302 7.56225L4.95719 7.5605L4.93774 7.61665C4.92801 7.64649 3.94391 10.5369 1.37662 13.6694C0.949575 14.1883 0.490781 14.6733 0.00558099 15.1207C1.53715 14.4552 2.94075 13.5317 4.10738 12.407C6.67467 9.92157 7.65876 7.62833 7.66849 7.60466L7.68795 7.5601L7.68378 7.56149L7.66432 7.51694C7.64112 7.46341 6.65257 5.18264 4.1032 2.71464C2.9363 1.58874 1.53231 0.66524 0 4.00543e-05C0.485731 0.44794 0.944995 0.933538 1.37244 1.45334C3.9218 4.56404 4.91001 7.43761 4.93322 7.50509L4.93357 7.50609Z" fill="currentColor"></path></svg>
            </a>
        </div>
    </div>
    <div class="grid grid-cols-5 gap-[1px]">
        <div class="relative pt-[120%]">
            <img src="http://127.0.0.1:8000/storage/theme/13/zNfOkoGp2Wc1ZjOKgxgXGxLCZirn47STlMoFzxpa.webp" alt="" class="w-full h-full object-cover absolute top-0 left-0" />
        </div>
        <div class="relative pt-[120%]">
            <img src="http://127.0.0.1:8000/storage/theme/13/oMsyjpkx8GralhZGI6azqN4dWswDluSy1FFu4ISP.webp" alt="" class="w-full h-full object-cover absolute top-0 left-0" />
        </div>
        <div class="relative pt-[120%]">
            <img src="http://127.0.0.1:8000/storage/theme/13/FOVZJqJ5qWByjIDFmdyn33KLJLrhXMk3o6QhDKwN.webp" alt="" class="w-full h-full object-cover absolute top-0 left-0" />
        </div>
        <div class="relative pt-[120%]">
            <img src="http://127.0.0.1:8000/storage/theme/13/jSFtwgau6b1pb45lVY2BTvrVWFnZBsB289UtElWI.webp" alt="" class="w-full h-full object-cover absolute top-0 left-0" />
        </div>
        <div class="relative pt-[120%]">
            <img src="http://127.0.0.1:8000/storage/theme/13/SxcL9eRC6BE9M8jWtuWfNWtBQfLXz6kCByBi3VMF.webp" alt="" class="w-full h-full object-cover absolute top-0 left-0" />
        </div>
    </div>
</section>
<footer class="bg-black text-white max-sm:mt-10">
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        <!-- For Desktop View -->
        <div>
            <h2 class="text-sm font-secondary" role="heading"
                aria-level="2">
                About Us
            </h2>
                ...
                <div>
                    ...
                    >
                        ...
                        <div class="flex items-center gap-4">
                            <img src="{{ asset('storage/theme/13/allCard.png') }}" alt="card" class="object-contain w-full" width="150" height="75" />
                        </div>
                    </x-shop::form>
                </div>
            </div>
