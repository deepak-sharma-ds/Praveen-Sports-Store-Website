...
@pushOnce('scripts')
    ...
    >
        ...
        >
            <div class="relative w-full overflow-hidden">
                ...
                >
                    <x-shop::media.images.lazy
                        class="after:content-[' '] relative bg-white transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105 w-full aspect-[9/11] object-contain"
            ...
            <div class="content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out">
        ...
        <div
            ...
            v-else
        >
            <div class="group relative aspect-square max-w-[250px] overflow-hidden">

                {!! view_render_event('bagisto.shop.components.products.card.image.before') !!}

                <a :href="`{{ route('shop.product_or_category.index', '') }}/${product.url_key}`">
                    <x-shop::media.images.lazy
                        class="after:content-[' '] aspect-square object-contain relative min-w-[250px] bg-white transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105"
                        ::src="product.base_image.medium_image_url"
                        ::key="product.id"
                        ::index="product.id"
                        width="291"
