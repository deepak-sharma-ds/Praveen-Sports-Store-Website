    ...
    <div class="container mt-8 px-[60px] max-lg:px-8">
        <div class="grid place-items-center gap-y-5 max-md:gap-y-2.5">
            ...
            <img class="max-md:h-[100px] max-md:w-[100px]" src="{{ bagisto_asset('images/thank-you.png') }}"
                alt="@lang('shop::app.checkout.success.thanks')" title="@lang('shop::app.checkout.success.thanks')" loading="lazy" decoding="async">
...
@push('scripts')
    <script>
        ...
        // Prevent duplicate purchase event (VERY IMPORTANT)
        if (!window.purchaseTracked) {
            ...
            dataLayer.push({
                ...
                ecommerce: {
                    ...
                    currency: "{{ $order->order_currency_code ?? 'INR' }}",
                    items: [
